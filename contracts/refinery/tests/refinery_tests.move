...
use core::{entity::{Self, Entity}, entity_key, location_service, object_registry::{Self, ObjectRegistry}};
...
fun new_recipe_length_mismatch_aborts() {
    ...
    let _r = recipe::new_recipe(INPUT_TYPE, INPUT_QTY, vector[89258, 78423], vector[20], PROCESSING_MS);
    abort
}
