...
// Abort Code Decoder
const abortCodeInput = document.getElementById(
  'abort-code-input',
) as HTMLInputElement
const decodeButton = document.getElementById(
  'decode-button',
) as HTMLButtonElement
const decoderOutput = document.getElementById(
  'decoder-output',
) as HTMLPreElement
const copyDecoderButton = document.getElementById(
  'copy-decoder',
) as HTMLButtonElement
...
async function handleDecode() {
  ...
  try {
    ...
    const errorMsg =
      error instanceof Error ? error.message : 'Invalid abort code format'
...
// Error String Parser
const errorStringInput = document.getElementById(
  'error-string-input',
...
const copyParserButton = document.getElementById(
  'copy-parser',
) as HTMLButtonElement
...
function handleParse() {
  ...
  try {
    ...
    const errorMsg =
      error instanceof Error ? error.message : 'Failed to parse error string'
